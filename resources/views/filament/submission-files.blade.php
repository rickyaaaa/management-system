<div class="space-y-4 p-2 text-sm">
    <div class="rounded-xl border border-gray-200 p-4">
        <div class="mb-1 text-xs font-semibold uppercase tracking-wider text-gray-400">File Submission</div>
        <div class="font-mono text-gray-700 break-all">{{ $submission->file_url }}</div>
        <a href="{{ route('secure.file', $submission->id) }}"
           target="_blank"
